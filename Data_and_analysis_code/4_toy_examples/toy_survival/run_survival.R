...
plot(x,log10(y),type='l',lwd=ll, main = 'Mortality of individuals',xaxt='n',yaxt='n',xlab = 'Time, years', ylab = 'Log probability of surviving')
...
plot(x,log10(y),type='l',lwd=ll, main = 'Survivorship',xaxt='n',yaxt='n',xlab = 'Age', ylab = 'Log probability of surviving')
points(x,log10(y2),type='l',lwd=ll)
points(x,log10(y3),type='l',lwd=ll)
...
pdf('fig_expansion_species.pdf',width = wd,height = ht)
plot(x,log10(y),type='l',lwd=ll, main = 'Expansion in space',xaxt='n',yaxt='n',xlab = 'Range size', ylab = 'Log probability of expansion')
points(x,log10(y2),type='l',lwd=ll)
points(x,log10(y3),type='l',lwd=ll)
